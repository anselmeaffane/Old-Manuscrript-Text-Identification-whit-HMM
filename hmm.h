...
//#define ALPHABET {"ٌ  ِ  َ ‫ل‬ ‫ك‬ ‫ق‬ ‫ف‬ ‫غ‬ ‫ع‬ ‫ظ‬ ‫ط‬ ‫ض‬ ‫ص‬ ‫ش‬ ‫س‬ ‫ز‬ ‫ر‬ ‫ذ‬ ‫د‬ ‫خ‬ ‫ح‬ ‫ج‬ ‫ث‬ ‫ت‬ ‫ب‬ ‫ء ‬ "}
//#define ALPHABET {"abcdefghijklmnopqrstuvwxyz "}
//#define ALPHABET {"ⴰⴱⴳⵯⴷⴹⴻⴼⴽⵯⵀⵃⵄⵅⵇⵉⵊⵍⵎⵏⵓⵔⵕⵖⵙⵚⵛⵜⵟⵡⵢⵣⵥ "}
#define ALPHABET {"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234 "}
